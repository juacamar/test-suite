...
public interface FilesLocations {
 ...
 public static String DATAOFTHEEXECUTIONPATH = "./src/test/resources/DataOfTheExecution.properties";
 public static String TESTDATASOURCEXMLPATH =  "./src/test/resources/";
