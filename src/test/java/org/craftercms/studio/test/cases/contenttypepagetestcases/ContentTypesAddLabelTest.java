...
public class ContentTypesAddLabelTest {
	...
	public void dragAndDrop() {
		...
		// driverManager.getDriver().findElement(By.xpath(controlsSectionLabelLocator));
	...
	public void contentTypeAddLabelTest() {
		...
		String titleText = this.driverManager
				.driverWaitUntilElementIsPresentAndDisplayed(2, "xpath", contentTypeContainerLabelTitleLocator)
				.getText();
		//driverManager.getDriver().findElement(By.xpath(contentTypeContainerLabelTitleLocator)).getText();
