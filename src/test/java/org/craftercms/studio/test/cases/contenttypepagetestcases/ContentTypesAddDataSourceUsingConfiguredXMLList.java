...
public class ContentTypesAddDataSourceUsingConfiguredXMLList {
...
//	private String contentTypeContainerChildContentTitleLocator;
	...
	public void beforeTest() {
		...
		this.siteConfigPage.createConfiguredListXML();
		configuredXMLListLocation = siteConfigPage.dataSourceXMLFileLocation;
		configuredXMLListName = siteConfigPage.dataSourceXMLFileName;
	...
	@Test(priority = 0)
	public void contentTypeAddDataSourceUsingConfiguredXMLList() {
...
//		String titleText = driverManager.getDriver().findElement(By.xpath(contentTypeContainerChildContentTitleLocator))
//				.getText();
//
