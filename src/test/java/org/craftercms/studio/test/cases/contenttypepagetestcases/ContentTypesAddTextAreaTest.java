...
public class ContentTypesAddTextAreaTest {
	...
	public void dragAndDrop() {
		...
		WebElement FromRepeatingGroup = this.driverManager.driverWaitUntilElementIsPresentAndDisplayed(2, "xpath",
	...
	public void contentTypeAddTextAreaTest() {
		...
		String titleText = this.driverManager
				.driverWaitUntilElementIsPresentAndDisplayed(2, "xpath", contentTypeContainerTextAreaTitleLocator)
				.getText();
