...
public class ContentTypesAddTextAreaTest {
	...
	public void dragAndDrop() {
		...
		WebElement FromRepeatingGroup = this.driverManager.driverWaitUntilElementIsPresentAndDisplayed(3, "xpath",
				controlsSectionTextAreaLocator);
		// driverManager.getDriver().findElement(By.xpath(controlsSectionTextAreaLocator));
	...
	public void contentTypeAddTextAreaTest() {
		...
		String titleText = this.driverManager
				.driverWaitUntilElementIsPresentAndDisplayed(3, "xpath", contentTypeContainerTextAreaTitleLocator)
				.getText();
		// driverManager.getDriver().findElement(By.xpath(contentTypeContainerTextAreaTitleLocator))
		// .getText();
