...
public class ContentTypesAddDropdownTest {
	...
	public void dragAndDrop() {
		...
		WebElement FromDropDown = this.driverManager.driverWaitUntilElementIsPresentAndDisplayed(this.defaultTimeOut, "xpath",
	...
	public void contentTypeAddDropdownTest() {
		...
		String titleText = 	this.driverManager.driverWaitUntilElementIsPresentAndDisplayed(this.defaultTimeOut, "xpath", contentTypeContainerDropdownTitleLocator).getText();
