...
public class ContentTypesAddDropdownTest {
	...
	public void dragAndDrop() {
		...
		WebElement FromDropDown = this.driverManager.driverWaitUntilElementIsPresentAndDisplayed(3, "xpath",
	...
	public void contentTypeAddDropdownTest() {
		...
		String titleText = 	this.driverManager.driverWaitUntilElementIsPresentAndDisplayed(3, "xpath", contentTypeContainerDropdownTitleLocator).getText();
