...
public class DesignOfCreateSitePageTest {
	...
	public void Design_of_create_site_page() {
		...
		WebElement logoCrafter = this.driverManager.driverWaitUntilElementIsPresentAndDisplayed(this.defaultTimeOut,
				"cssSelector", ".navbar-brand > img");

		Assert.assertTrue(logoCrafter.isDisplayed());

		// Assert sites title is present.
		WebElement sitesLabel = this.driverManager.driverWaitUntilElementIsPresentAndDisplayed(this.defaultTimeOut,
		...
		WebElement adminTools = this.driverManager.driverWaitUntilElementIsPresentAndDisplayed(this.defaultTimeOut,
		...
		WebElement sitesOption = this.driverManager.driverWaitUntilElementIsPresentAndDisplayed(this.defaultTimeOut,
		...
		WebElement helpOption = this.driverManager.driverWaitUntilElementIsPresentAndDisplayed(this.defaultTimeOut,
				"cssSelector", ".nav > li:nth-child(3) > a:nth-child(1)");

		Assert.assertTrue(helpOption.isDisplayed());

		// Assert account option is present.
		WebElement accountOption = this.driverManager.driverWaitUntilElementIsPresentAndDisplayed(this.defaultTimeOut,
				"cssSelector", ".dropdown-toggle");
		Assert.assertTrue(accountOption.isDisplayed());

		// Assert all sites option is present.
		WebElement sitesPerPage = this.driverManager.driverWaitUntilElementIsPresentAndDisplayed(this.defaultTimeOut,
		...
		WebElement sitesPerPageCombo = this.driverManager.driverWaitUntilElementIsPresentAndDisplayed(
				this.defaultTimeOut, "cssSelector", "#container > div > div > div.pull-right.m10 > input");
