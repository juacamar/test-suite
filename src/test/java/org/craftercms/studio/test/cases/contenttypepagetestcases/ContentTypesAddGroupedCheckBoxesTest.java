...
public class ContentTypesAddGroupedCheckBoxesTest {
	...
	public void beforeTest() {
		...
		this.contentTypeContainerGroupedCheckBoxesTitleLocator = uIElementsPropertiesManager.getSharedUIElementsLocators()
	...
	public void dragAndDrop() {
		...
		WebElement FromGroupedCheckBoxes = driverManager.getDriver()
