...
public class ContentTypesAddItemSelectorTest {
	...
	public void dragAndDrop() {
		...
		WebElement FromItemSelector = this.driverManager.driverWaitUntilElementIsPresentAndDisplayed(this.defaultTimeOut, "xpath",
	...
	public void contentTypeAddItemSelectorTest() {
		...
		String titleText = this.driverManager
				.driverWaitUntilElementIsPresentAndDisplayed(this.defaultTimeOut, "xpath", contentTypeContainerItemSelectorTitleLocator)
				.getText();
