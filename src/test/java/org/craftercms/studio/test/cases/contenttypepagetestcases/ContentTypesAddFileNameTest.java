...
public class ContentTypesAddFileNameTest {
	...
	public void dragAndDrop() {
		...
		WebElement FromFileName = this.driverManager.driverWaitUntilElementIsPresentAndDisplayed(2, "xpath",
	...
	public void contentTypeAddFileNameTest() {
		...
		String titleText = this.driverManager
				.driverWaitUntilElementIsPresentAndDisplayed(2, "xpath", contentTypeContainerFileNameTitleLocator)
				.getText();
