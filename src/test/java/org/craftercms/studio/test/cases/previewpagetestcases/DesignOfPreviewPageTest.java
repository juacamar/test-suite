...
public class DesignOfPreviewPageTest {
	...
	public void Design_of_preview_page() {
		...
		WebElement logoCrafter = this.driverManager.driverWaitUntilElementIsPresentAndDisplayed(defaultTimeOut, "xpath",
		...
		WebElement siteContent = this.driverManager.driverWaitUntilElementIsPresentAndDisplayed(defaultTimeOut, "xpath",
		...
		WebElement searchField = this.driverManager.driverWaitUntilElementIsPresentAndDisplayed(defaultTimeOut, "id",
				"acn-searchtext");
		...
		WebElement signUp = this.driverManager.driverWaitUntilElementIsPresentAndDisplayed(defaultTimeOut, "cssSelector",
				"#account-dropdown");
		
		Assert.assertTrue(signUp.isDisplayed());

		// Assert Edit option is present.
		WebElement editOption = this.driverManager.driverWaitUntilElementIsPresentAndDisplayed(defaultTimeOut, "xpath",
				"/html/body/div[2]/div[1]/nav/div/div[2]/ul[3]/li[2]/a");

		Assert.assertTrue(editOption.isDisplayed());

		// Assert delete option is present.
		WebElement deleteOption = this.driverManager.driverWaitUntilElementIsPresentAndDisplayed(defaultTimeOut, "xpath",
		...
		WebElement scheduleOption = this.driverManager.driverWaitUntilElementIsPresentAndDisplayed(defaultTimeOut, "xpath",
		...
		WebElement approvePublishOption = this.driverManager.driverWaitUntilElementIsPresentAndDisplayed(defaultTimeOut, "xpath",
		...
		WebElement duplicateOption = this.driverManager.driverWaitUntilElementIsPresentAndDisplayed(defaultTimeOut, "cssSelector",
		...
		WebElement historyOption = this.driverManager.driverWaitUntilElementIsPresentAndDisplayed(defaultTimeOut, "cssSelector",
				"#activeContentActions > li:nth-child(5) > a");
		...
		WebElement dashboard = this.driverManager.driverWaitUntilElementIsPresentAndDisplayed(defaultTimeOut, "cssSelector",
				"#acn-dropdown-menu-inner > div.studio-view");
		Assert.assertTrue(dashboard.isDisplayed());

	
		// Assert Users option is present.
		WebElement usersOption = this.driverManager.driverWaitUntilElementIsPresentAndDisplayed(defaultTimeOut, "cssSelector",
		...
		WebElement sitesOption =this.driverManager.driverWaitUntilElementIsPresentAndDisplayed(defaultTimeOut, "cssSelector",
				"#studioBar > nav > div div.collapse.navbar-collapse > div > ul  > li:nth-child(1) > a");
		Assert.assertTrue(sitesOption.isDisplayed());

		// Assert admin console option is present.
		WebElement adminConsoleOption =this.driverManager.driverWaitUntilElementIsPresentAndDisplayed(defaultTimeOut, "cssSelector",
