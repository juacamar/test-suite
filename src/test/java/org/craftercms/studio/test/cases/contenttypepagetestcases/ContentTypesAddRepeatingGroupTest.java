...
public class ContentTypesAddRepeatingGroupTest {
	...
	public void dragAndDrop() {
		...
		WebElement FromRepeatingGroup = this.driverManager.driverWaitUntilElementIsPresentAndDisplayed(this.defaultTimeOut, "xpath",
	...
	public void contentTypeAddRepeatingGroupTest() {
		...
		String titleText = this.driverManager
				.driverWaitUntilElementIsPresentAndDisplayed(this.defaultTimeOut, "xpath", contentTypeContainerRepeatingGroupTitleLocator)
				.getText();
