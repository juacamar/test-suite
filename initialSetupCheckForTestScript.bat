...
IF EXIST craftercms (
@rem moving to craftercms folder
...
@rem removing all the old enviroments
echo [INFO] removing old enviroments
rd /s /q crafter-authoring
rd /s /q crafter-delivery

@rem executing the .\gradlew.bat selfupdate
...
@rem executing the .\gradlew.bat update
